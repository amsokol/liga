...
config = {
    ...
    "features": {
        "calt": [
            ...
            "less_plus_greater", # <+>
            "less_slash_greater", # </>
            "numbersign_underscore_parenleft", # #_(
            "period_period_equal", # ..=
            # "period_period_less", # ..<
            ...
            # "lowercase_plus",
            # "lowercase_asterisk",
            # "lowercase_asteriskmath",  # Requires asteriskmath glyph
            # "uppercase_colon",
            # "numbersigns",
            # "underscores",
        ],
        # "ss01": [],  # Excluded to preserve Google Sans Code's original ss01 (alternative 'g')
        "ss02": [],
        "ss03": [],
        "ss04": [],
        "ss05": [],
        ...
        # "cv15": [],  # Requires asteriskmath glyph
        # "cv16": [],  # Requires asteriskmath glyph
        "cv17": [],
        "cv18": [],
        "cv19": [],
        "cv20": [
